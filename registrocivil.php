...
<div class="wrapp">
  <div class="row">
    ...
    <div class="col-m-12 " style="margin:15px;padding:15px;  border-radius:5px;background-color:rgb(14,138,16); ">
      <h3 style="color:rgb(235, 233, 35); text-align:center;  font-family: 'Wire One', sans-serif;">REGISTRO CIVIL</h3>
    </div>
    ...
    <div class="col-md-8">
     <div class="row" style="text-align: justify;">
       <div class="col-md-12">
         <iframe src="http://docs.google.com/gview?url=http://munijuanespinozamedrano.gob.pe/registro.pdf&embedded=true" style="width:100%; height:900px;" frameborder="0"></iframe>
